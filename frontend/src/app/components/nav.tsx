  ...
  return (
    <nav className="">
          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex shrink-0 items-center">
                <AppLogo></AppLogo>
                <span className="hidden sm:inline-block text-primary ml-2">{companyName}</span>
              </div>
      ...
      <div className="bg-secondary">
        <div className="hidden sm:block max-w-7xl py-2">
          <div className="flex space-x-4 gap-4 justify-center items-center">
            ...
            {/* class of inactive: rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white */}
      ...
      <div
        className={`sm:hidden ${navOpen ? "block" : "hidden"}`}
        id="mobile-menu"
      >
