  ...
  return (
    <div className="bg-third rounded-lg h-[420px] w-[300px] p-5">
      <div className="relative rounded-lg h-[272px]">
        <span className="bg-red-600 text-white uppercase rounded-r-lg absolute top-0 left-0 size-fit">New</span>
